...
##For Africa
ggplot(BestandWorest_Afria, aes(x = year, y = lifeExp ,
                             colour = country)) + geom_point() + geom_line() + stat_smooth(method = "lm") + facet_wrap( ~ country) + ggtitle("The Best And Worest countries in Africa ")
ggsave("Best_Worest_Countries_Africa.png")
##For Asia
ggplot(BestandWorest_Asia, aes(x = year, y = lifeExp, 
                            colour = country)) + geom_point() + geom_line() + stat_smooth(method = "lm") + facet_wrap( ~ country) + ggtitle("The Best And Worest countries in Asia ")
ggsave("Best_Worest_Countries_Asia.png")
##For Americas
ggplot(BestandWorest_Americas, aes( x = year, y = lifeExp, 
                                colour = country)) + geom_point() + geom_line() + stat_smooth(method = "lm") + facet_wrap( ~ country) + ggtitle("The Best And Worest countries in Americas ")
ggsave("Best_Worest_Countries_Americas.png")

##For Europe
ggplot(BestandWorest_Europe, aes(x = year, y = lifeExp,
                              colour = country)) + geom_point() + geom_line() + stat_smooth(method = "lm") + facet_wrap( ~ country) + ggtitle("The Best And Worest countries in Europe ")
